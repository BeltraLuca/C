#include <stdio.h>	//necessario per buffsize e printf
#include <stdlib.h>	//necessario per l'exit
#include <unistd.h>	//necessario per create, open, close
#include <fcntl.h>	//necessario per le macro O_RDONLY
